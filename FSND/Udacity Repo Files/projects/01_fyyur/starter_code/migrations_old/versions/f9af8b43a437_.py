...
Revision ID: f9af8b43a437
Revises: d6b6427fe706
Create Date: 2020-12-22 16:26:37.696399
...
revision = 'f9af8b43a437'
down_revision = 'd6b6427fe706'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    #Ali: Tables reordered to drop. originally, Venue was prior to Show and caused the following error: 

    #sqlalchemy.exc.InternalError: (psycopg2.errors.DependentObjectsStillExist) cannot drop table "Venue" because other objects depend on it
    # DETAIL:  constraint Show_venue_id_fkey on table "Show" depends on table "Venue"
